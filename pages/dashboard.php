          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3><?php echo $banyakTempat?></h3>
                  <p>Jumlah Tempat Yang di kunjungi</p>
                </div>
                <div class="icon">
                  <i class="ion ion-stats-bars"></i>
                </div>
                <a href="./catatan.php" class="small-box-footer">Selengkapnya... <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          <!-- /.row -->
