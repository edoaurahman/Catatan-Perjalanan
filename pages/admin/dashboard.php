...
$nik = $_SESSION['nik'];
$query = mysqli_query($conn, "SELECT * FROM users WHERE level = 'user'");
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                ...
                <a href="./daftar_user.php" class="small-box-footer">Selengkapnya... <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          <!-- /.row -->
